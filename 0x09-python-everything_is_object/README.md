...
During this project, I explored the concept of object instantiation in Python, focusing on topics such as variable aliasing, object identifiers, types, and mutability. The project consisted of a set of quiz-like questions, to which I responded by providing my answers in single-line .txt files.
