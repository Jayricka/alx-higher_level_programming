...
In this project, I learned file handling in Python. I used the builtins `with`, `open`, and `read` functions with the `json` module to read and write files and serialize and deserialize objects with JSON.
